const ITINERARY = {
  ...
  ui: {
    en: {
      ...
      installQrTitle: "Install on Your Phone",
      installQrHint: "Scan to open the itinerary, then add it to your home screen — no app store needed.",
    ...
    zh: {
      ...
      installQrTitle: "手机安装行程",
      installQrHint: "扫码打开网页，再添加到主屏幕即可，无需应用商店。",
