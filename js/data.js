const ITINERARY = {
      ...
      },
      {
        ...
        trip: {
          segments: [
            ...
            { t: { en: " (Day 8), ", zh: "（第 8 天），" } },
            { t: { en: "Dazu Rock Carvings", zh: "大足石刻" }, day: 10, actIndex: 2 },
  ...
  preDeparture48h: {
    ...
    items: [
      ...
      },
      {
        ...
        desc: {
          en: "Book Chengdu–Jiuzhaigou and Chengdu–Chongqing HSR on Trip.com (12306 needs a Chinese phone). D10 Dazu: reserve the Jiefangbei↔Dazu direct shuttle via WeChat 「重庆自由行」—not on 12306. For Jiuzhaigou, select Huanglongjiuzhai (黄龙九寨) station—not Jiuzhaigou town.",
          zh: "成都↔九寨沟、成都↔重庆高铁可在 Trip.com 购票（12306 需中国手机号）。D10 大足：请微信「重庆自由行」预订解放碑↔大足直通车（非 12306）。九寨沟方向请在「黄龙九寨」站（Huanglongjiuzhai）上下车，而非九寨沟县城。",
        },
  ...
  days: [
    ...
    },
    {
      ...
      intensity: "compact",
      hotel: "kaiyuan",
      subtotal: { cny: 774, usd: 114.32 },
      summary: { en: "Direct shuttle · Baodingshan · back ~18:00", zh: "直通车往返 · 宝顶山 · 约 18:00 返酒店" },
      activities: [
        {
          time: "08:00",
          type: "food",
        ...
        },
        {
          time: "08:00",
          type: "transport",
          title: { en: "Direct Shuttle: Jiefangbei ↔ Dazu", zh: "解放碑↔大足石刻直通车（往返）" },
          desc: {
            en: "Book round-trip seats at least 1 day ahead via WeChat 「重庆自由行」 or cqzyx.net (~¥78/person round-trip; ~¥48 one-way). Board 08:00 at the Chongqing Bombing Memorial (50 m west of Bayi Rd & Ciqikou St, Jiefangbei; Metro Line 6 Xiaoshizi exit 5A)—5 min walk from Kaiyuan Mingting. Optional pick-up 08:30 Hongqihegu. Arrive Baodingshan visitor center ~10:00 (~2 hr). Return bus 16:00 from the same parking lot; back to Jiefangbei ~18:00. Door-to-door—easier and cheaper than HSR + station transfers from your hotel.",
            zh: "请提前 1 天在微信公众号「重庆自由行」或 cqzyx.net 预订往返车位（约 78 元/人往返，单程约 48 元）。08:00 在解放碑大轰炸惨案遗址上车（八一路与磁器街交叉口西 50 米，地铁 6 号线小什字站 5A 口；距开元名庭步行约 5 分钟），08:30 经停红旗河沟。约 10:00 抵达宝顶山游客中心（车程约 2 小时）。16:00 原地上车返渝，约 18:00 回到解放碑。酒店出发一站直达，比高铁+多次转车更省心、更经济。",
          },
          cost: { cny: 78, usd: 11.52, note: { en: "round-trip / person", zh: "往返/人" } },
          image: "images/shuttle-bus.svg",
        },
        {
          time: "10:00–14:30",
        ...
        },
        {
          time: "16:00",
          type: "transport",
          title: { en: "Return Shuttle to Jiefangbei", zh: "直通车返解放碑" },
          desc: {
            en: "Included in your round-trip ticket—same parking lot as drop-off. Back near Kaiyuan Mingting ~18:00; 10-day itinerary complete.",
            zh: "已含在往返车票内，原地上车；约 18:00 抵达开元名庭附近，全部行程正式完结。",
          },
          cost: null,
          image: "images/shuttle-bus.svg",
        },
  ...
  budgetBreakdown: {
    ...
    days: [
      ...
      },
      {
        ...
        items: [
          { label: { en: "Direct shuttle Jiefangbei↔Dazu (×2, round-trip)", zh: "解放碑↔大足石刻直通车往返（×2）" }, cny: 156, usd: 23.04 },
    ...
    optional: {
      ...
      items: [
        ...
        { en: "Chongqing hot pot with a mild or clear broth—any evening in Chongqing (D8–D10)", zh: "重庆鸳鸯火锅（清汤/微辣）— D8–D10 渝期间任一晚间自选" },
  ...
  ui: {
    en: {
      ...
      downloadSuccess: "Download successful — check your downloads folder.",
      downloadError: "Download failed. Please try again.",
      contactTitle: "Trip Inquiry",
      contactHint: "Send a message—I'll reply by email. Your details are used only to respond.",
      contactName: "Name",
      ...
      contactSuccess: "Thanks! I've received your message and will reply soon.",
    ...
    zh: {
      ...
      downloadBtn: "下载 .docx",
      downloadBusy: "下载中…",
      downloadSuccess: "下载成功，请查看本机下载文件夹。",
      ...
      contactSubmit: "发送留言",
      contactSending: "发送中…",
      contactSuccess: "感谢留言！我已收到，会尽快回复。",
...
const ACTIVITY_OVERVIEWS = {
  ...
  "Direct Shuttle: Jiefangbei ↔ Dazu": {
    en: "Official tourist coach from Jiefangbei Bombing Memorial to Baodingshan visitor center—no HSR or Dazu South taxi changes. Fixed morning departure and 16:00 return suit a relaxed Baodingshan visit from your Jiefangbei hotel.",
    zh: "重庆市旅游直通车，解放碑大轰炸遗址直达宝顶山游客中心，无需高铁转车。固定早班去、16:00 返，适合从解放碑酒店出发的大足一日游。",
  },
