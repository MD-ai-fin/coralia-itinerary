const ITINERARY = {
  ...
  budgetBreakdown: {
    title: { en: "Daily Fixed Costs", zh: "每日固定消费" },
    subtitle: {
    ...
    optional: {
      title: { en: "Optional Expenses", zh: "自费项目" },
      items: [
